      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <div className="mt-2 space-y-2">
            {Array.isArray(checkIn.achievements) && checkIn.achievements.length > 0 && (
              <div>
            ...
            {Array.isArray(checkIn.challenges) && checkIn.challenges.length > 0 && (
              <div>
            ...
            {Array.isArray(checkIn.nextMonthPriorities) && checkIn.nextMonthPriorities.length > 0 && (
              <div>
